                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mt-3">
                                            ...
                                            <h5 class="mb-0 mt-2">
                                                <span class="text-muted me-2"></span>{{ $cart->price }} ft
                                            </h5>
                                        </div>
                                    </div>
                    ...
                    <div class="card border shadow-none">
                        <div class="card-header bg-transparent border-bottom py-3 px-4">
                            <h5 class="font-size-16 mb-0">
                                Teljes rendelés: <span class="float-end"></span>
                            </h5>
                        </div>
                                ...
                                <table class="table mb-0">
                                    <tbody>
                                        ...
                                        <tr class="bg-light">
                                            <th>Végösszeg:</th>
                                            <td class="text-end">
                                                <span class="fw-bold">{{ $total }} ft</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div class="my-4 text-center">
                ...
                @else
                    ...
                    <p class="p-2 border border-warning rounded" style="color: #FFC300;">
                        📦 Rendelj még {{ number_format($remaining, 0, ',', ' ') }} Ft értékben az ingyenes szállításhoz!
                    </p>
                @endif
            </div>
        </div>
